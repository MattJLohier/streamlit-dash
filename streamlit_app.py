...
st.info('This is the official dashboard for the Scooper Tool. Scooper is a Python tool hosted on AWS (Lambda/S3/EC2) that uses Selenium and Pandas to scrape for new product certifications and placements on official manufacturer websites.' <br> 'Scooper currently scrapes certifications from EnergyStar, WiFi Alliance, and EPEAT, and checks for new products on the official sites of HP, Canon, Kyocera, Konica Minolta, Lexmark, Ricoh, Sharp, Toshiba, Xerox, and Fujifilm')
st.divider()
