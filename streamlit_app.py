...
st.info('This is the official dashboard for the Scooper Tool. Scooper is a Python tool hosted on AWS (Lambda/S3/EC2) that uses Selenium and Pandas to scrape for new product certifications and placements on official manufacturer websites. <br> Scooper test')
st.divider()
