...
def page2():
    ...
    for index, row in latest_df4.iterrows():
        ...
        bg_color = '#ffdbdb' if metric_label == 'Removed' else '#aabbd3' if metric_label == 'Added' else '#F5F5F5'  # Light red for Removed, light green for Added, light gray otherwise
